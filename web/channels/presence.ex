defmodule Volition.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule Volition.MyChannel do
        use Volition.Web, :channel
        alias Volition.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :volition,
                        pubsub_server: Volition.PubSub
end
